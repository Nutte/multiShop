        ...
        <div class="max-w-7xl mx-auto w-full px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div class="order-2 md:order-1 relative">
                ...
                <div class="bg-white text-black p-6 max-w-md transform rotate-1 shadow-[10px_10px_0px_rgba(255,255,255,0.2)]">
                    ...
                    <div class="mt-4 flex gap-4">
                        <a href="{{ route('shop.products') }}" class="font-spray text-xl text-pink-600 hover:text-black underline decoration-wavy">Go to Drop -></a>
                    </div>
                </div>
            </div>
            ...
            <div class="order-1 md:order-2 relative group">
                <div class="relative z-10 border-4 border-white bg-white shadow-2xl transform rotate-2 group-hover:rotate-0 transition duration-500">
                    <img src="https://scontent.cdninstagram.com/v/t51.82787-15/601315408_17892691809383405_4512345617872613146_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=104&ig_cache_key=Mzc4ODkwODA1OTk5Mzg3MjMxMA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTgwMC5zZHIuQzMifQ%3D%3D&_nc_ohc=vANY6vnLNPsQ7kNvwGEQIr5&_nc_oc=AdnUUhYMwu_MHsG5LbWzILFJHL3aHUt9iITJApW4MHhxIEpDmXsP1YO1Huy2yK-43eQ&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=scontent.cdninstagram.com&_nc_gid=PMO2DZcrQnHXnNlTFQy_qQ&oh=00_Afpqg_BS-gdAIUSjk__XB-NyTQ8uDm16U6nXk7lXrFF41g&oe=69606FFB" class="w-full h-auto grayscale contrast-125 hover:grayscale-0 transition duration-500">
